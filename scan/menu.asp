        ...
        $(document).ready(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href = "http://192.168.35.5/login.asp?href=http://192.168.35.5/basket/scan/default.asp?ID=" & ID & "";
...
<nav class="navbar navbar-light bg-light fixed-top shadow">
  <a class="navbar-brand" href="#"><i class="fa-solid fa-basket-shopping"></i></a>
